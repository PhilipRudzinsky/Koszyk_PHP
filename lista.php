...
?>
    ...
    <html>
    <head>
        <title>Koszyk zakupów</title> <meta charset="UTF-8"> </head>
    <body>
    <p><b>Lista artykułów</b></p> <?php
if (isset($_POST['lista'])) {
    ...
    <form action="lista.php" method="post">
        <p>Wybór produktu:</p>
        <p>
            <select name="lista[]" multiple="multiple" size = "9"> <option value="Monitor"> Monitor</option>
                ...
                <option value="Kamera internetowa"> Kamera internetowa</option> <option value="Słuchawki"> Słuchawki</option>
                <option value="Stacja DVD"> Stacja DVD</option>
                <option value="Dysk twardy"> Dysk twardy</option>
                <option value="Pendrive"> Pendrive</option>
                <option value="Komputer"> Komputer</option>
            </select></p>
        <p>Wybierz produkty, trzymając wciśnięty klawisz Ctrl.</p> <p><input type="submit" value="Wyślij"></p>
    </form>
